...
* 1.  job: Instrucciones y tareas del desarrollo de la app.
* 2.  auth: autenticacion, autorizador, enum, colecciones.
* 3.  components: componentes reusables.
* 4.  enums:  enums estaticos para mantener organizacion de datos.
* 5.  core: servicios y enums de lógica de negocio.
* 6.  data: constantes y data estatica.
* 7.  global: para signals globales (estados) de la app.
* 8.  interfaces: modelos del proyecto.
* 9.  tools: servicios y enum de utilidad completos.
* 10. views: para vistas dentro admin y pages.
